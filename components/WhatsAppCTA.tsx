    ...
    return (
        <AnimatePresence>
            {isVisible && (
                ...
                >
                    {/* Tooltip */}
                    <div className="mr-4 px-4 py-2 bg-neutral-900 border border-white/10 rounded-xl shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none hidden md:block">
